 <footer class="footer">
        <div class="container">
                ...
                <div class="col-4 col-md-2   align-self-center">				
                    <img class="align-text-center img-fluid"  src="assets/img/LogoTrans.png" />               
                </div>				
                <div class="offset-sm-2 col-5 ">
                    <h5>Our Address</h5>
                    <address>
		              Gopalpur, Ranjani Road, Pandharpur<br>
		              Solapur - 413304, Maharashtra<br>		              
		              <div class="btn-group text-center" role="group">
                    <a role="button" class="btn btn-primary" href="tel:+918446630809"><i class="fa fa-phone"></i> Call</a>
                    <!-- <a role="button" class="btn btn-info" href="tel:+918233294006"> <i class="fa fa-fax"></i> Fax</a> -->
                    <a role="button" class="btn btn-success" href="mailto:transagroofficial@gmail.com"> <i class="fa fa-envelope-o"></i> Email</a>
                </div>
		           </address>
                </div>				
