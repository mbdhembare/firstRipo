        ...
        <div class="container" >
          <div class="row row-header" >
            <div class="col-12 col-sm-7" >
              <h1 class="text-white">Crop Management</h1>
              <p class="text-white">
                  <b>Sow with confidence, reap with certainty.</b>
              </p>
              <div class="cg">
                <div class="card card-body bg-gradient-success">
                  <blockquote cite="blockquote">
                    <h6 class="mb-0 text-dark">
                      <em
                        ><b
                          > “The ultimate goal of farming is not the growing of crops, but the cultivation and perfection of human beings..”</b
                        ></em
                      >
                    </h6>
                    <br />
            ...
            <div class="col-12 col-sm-3 offset-sm-2 align-self-center">
              <img src="assets/img/LogoTrans.png" class="img-fluid" alt="" />
            </div>
          </div>
        </div>
      </header>
          ...
          <div class="row align-items-center"> 
            <div class="col-lg-5 col-md-8 mr-auto text-left"> 
              <div class="pr-md-5"> 
                ...
                <h3 class="display-3 text-justify">Our Services</h3>
                ...
                <ul class="list-unstyled mt-5"> 
                  <li class="py-2"> 
                    <div class="d-flex align-items-center"> 
                      ...
                      <div>
                        <h6 class="mb-0">Crops Information</h6>
                      </div>
                    </div>
                  </li>
                  <li class="py-2"> 
                    <div class="d-flex align-items-center"> 
                      ...
                      <div>
                        <h6 class="mb-0">Market Prices</h6>
                      </div>
                    </div>
                  </li>
                  <li class="py-2"> 
                    <div class="d-flex align-items-center"> 
                      ...
                      <div>
                        <h6 class="mb-0">Government Schemes and Loans</h6>
                      </div>
                    </div>
                  </li>
                  <li class="py-2"> 
                  ...
                  <li class="py-2"> 
                    <div class="d-flex align-items-center"> 
                      ...
                      <div>
                        <h6 class="mb-0">Crop Diseases and Pesticides</h6>
                      </div>
                    </div>
                  </li>
                  <li class="py-2"> 
